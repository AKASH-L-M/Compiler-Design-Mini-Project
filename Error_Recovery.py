# -*- coding: utf-8 -*-
"""
Created on Fri Nov 25 10:06:36 2022
...
#rules=["S-> int main()",
#"S -> begin X end | int A, A, A;",
#"A -> a | b | c",
#"X -> if(A OP A)S | printf(A);",
#"OP -> < | > | <= | >= | == | <> "]



#rules = ["S -> int main() | begin X end | int A , A , A ;", 
#        "A -> a | b | c", 
#       "X -> if ( A OP A ) S | printf ( A ) ;", 
#      "OP -> < | > | <= | >= | == | <>" ]

rules = ["S -> int main ( ) Y | int A , A , A ;", 
         "Y -> begin X end",
         "X -> D B | printf ( A ) ;",
         "D -> int A , A , A ;",
         "B -> IF",
         "A -> a G | b G | c G | d G | e G | f G | g G | h G | i G | j G | k G | l G | m G | n G | o G | p G | q G | r G | s G | t G | u G | v G | w G | x G | y G | z G", 
         "G -> a G | b G | c G | d G | e G | f G | g G | h G | i G | j G | k G | l G | m G | n G | o G | p G | q G | r G | s G | t G | u G | v G | w G | x G | y G | z G | 1 G | 2 G | 3 G | 4 G | 5 G | 6 G | 7 G | 8 G | 9 G | 0 G | # ",
         "IF -> if ( A OP A ) C", 
         "C -> Y",
         "OP -> < | > | <= | >= | == | <>" ]

nonterm_userdef=['S', 'A', 'X', 'OP', 'D', 'B', 'C', 'IF', 'Y', 'G']
term_userdef=['int', 'a', 'b', 'c', 'd', 'e', 'f', 'g' , 'h' , 'i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z', '1','2','3','4','5','6','7','8','9','0','printf', '(', ')', 'begin', 'end', 'main', '<', '>', '<=', '>=', '==', '<>', ',', ';', 'if']
file1 = open("intermediate.txt","r")
sample_input_string = file1.read()
print("String:",sample_input_string)
# int main ( ) begin int a 1 , b , c ; if ( a > b ) begin printf ( a ) ; end if ( c > a ) begin printf ( b ) ; end end  
#sample_input_string="int main ( ) begin int n 1 , b , c ; if ( a > b ) begin printf ( a ) ; end end"

#rules = ["S -> main() X", "X -> begin Q end", "Q -> printf ( A )", "A -> a | b | c "]

#rules=["S-> int main() | T I,I,I; | if(C)A | for(B;C;P)Z",
#"T -> int_",
#"I -> p | q | r | g",
#"C -> E R E",
#"E -> I"
...
#nonterm_userdef=['T','I', 'C', 'E', 'R', 'A', 'B', 'P', 'Z']
#term_userdef=['int main()','if','p','q','r','g','i', '(',')', '<', '>', '<=', '>=', '==', '<>']
#sample_input_string="if(p>q)g=i"

#nonterm_userdef=['S', 'A', 'X', 'Q']
#term_userdef=['a', 'b', 'c', 'printf', '(', ')', 'begin', 'end', 'main()']
#sample_input_string="main() begin printf ( a ) end"
